...
\begin{document}
  ...
  \section{Ejercicio 7}
    ...
    \begin{figure}[H]
      ...
      \caption{Resultados del análisis de la varianza según la variable \texttt{tipo de somnífero}}
      \label{fig:7_resanova}
    \end{figure}
    \paragraph{}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{ej7_dunnett.png}
      \caption{Resultados del test de dunnet de los niveles Estándar y Nuevo frente al control Placebo}
      \label{fig:7_resdunnett}
    \end{figure}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.7\textwidth]{ej7_contraste.png}
      \caption{Resultados del test de contraste comparando los dos tipos de somnífero}
      \label{fig:7_rescontraste}
    \end{figure}
